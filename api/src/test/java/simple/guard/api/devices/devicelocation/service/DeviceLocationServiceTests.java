...
class DeviceLocationServiceTests {
    ...
    private static final OffsetDateTime COLLECTED_AT = OffsetDateTime.parse("2026-08-19T09:00:00-03:00");
    private static final OffsetDateTime RECEIVED_AT = OffsetDateTime.parse("2026-08-19T09:00:05-03:00");

    @Mock
    private DeviceLocationRepository locations;
    ...
    void returnsExistingLocationWithoutPersistingAgainTests() {
        ...
        DeviceLocationResolution resolution = service.resolveLocation(DEVICE_ID, EVENT_ID, request, RECEIVED_AT);
    ...
    void persistsLocationWhenMissingTests() {
        ...
        when(locations.saveAndFlush(any(DeviceLocation.class))).thenAnswer(invocation -> invocation.getArgument(0));
    ...
    void returnsNullLocationWhenPayloadIsNullTests() {
        DeviceLocationResolution resolution = service.resolveLocation(DEVICE_ID, EVENT_ID, null, RECEIVED_AT);
