...
class AgentSignatureVerifierTests {
  ...
  private static String signatureTests(java.security.PrivateKey privateKey) throws Exception {
    return signatureTests(
        privateKey, AgentSignatureVerifier.unpairingPayload(DEVICE_ID, AGENT_INSTANCE_ID));
  }

  private static String signatureTests(java.security.PrivateKey privateKey, byte[] payload)
      throws Exception {
