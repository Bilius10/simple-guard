...
class ApiSecurityErrorHandlerTests {
    ...
    void setUpTests() {
        ...
        messageSource.addMessage("simple_guard_error_invalid_token", Locale.getDefault(), "Token invalido ou sessao expirada.");
        messageSource.addMessage("simple_guard_error_access_denied", Locale.getDefault(), "Acesso negado para este recurso.");
