...
class CriticalActionDomainTests {
    ...
    void exposesSupportedCriticalActionTypesTests() {
        assertThat(CriticalActionType.values()).containsExactly(
    ...
    void exposesSupportedStepUpRequirementsTests() {
        assertThat(CriticalActionStepUpRequirement.values()).containsExactly(
                CriticalActionStepUpRequirement.NOT_REQUIRED,
    ...
    void carriesCriticalActionConfirmationDataTests() {
        CriticalActionConfirmation confirmation = new CriticalActionConfirmation(
                CriticalActionType.UNPAIR_DEVICE,
                "device-123",
                CriticalActionStepUpRequirement.REQUIRED
        );
        CriticalActionConfirmation sameConfirmation = new CriticalActionConfirmation(
                CriticalActionType.UNPAIR_DEVICE,
                "device-123",
                CriticalActionStepUpRequirement.REQUIRED
        );
        ...
        assertThat(confirmation.stepUpRequirement()).isEqualTo(CriticalActionStepUpRequirement.REQUIRED);
    ...
    void carriesCriticalActionConfirmationDecisionDataTests() {
        CriticalActionConfirmationDecision decision = new CriticalActionConfirmationDecision(
                CriticalActionType.CLOSE_INCIDENT,
                "incident-456",
                true
        );
        CriticalActionConfirmationDecision sameDecision = new CriticalActionConfirmationDecision(
                CriticalActionType.CLOSE_INCIDENT,
                "incident-456",
                true
        );
