...
public class ApiSecurityErrorHandler implements AuthenticationEntryPoint, AccessDeniedHandler {
  ...
  public ApiSecurityErrorHandler(
      ApiErrorResponseFactory errorResponseFactory, ObjectMapper objectMapper) {
  ...
  private void write(HttpServletResponse response, HttpStatus status, ApiErrorResponse error)
      throws IOException {
