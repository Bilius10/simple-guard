...
public class DeviceController {
  ...
  UnpairDeviceResponse unpair(@PathVariable UUID deviceId, Authentication authentication) {
    return deviceService.unpairByAdministrator(deviceId, account(authentication));
  }
