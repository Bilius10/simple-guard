...
public class DeviceTelemetryService {
    ...
    @Transactional
    public DeviceTelemetryResponse ingest(UUID deviceId, String agentInstanceId, String signature, CreateDeviceTelemetryRequest request
    ) {
        ...
        DeviceLocationResolution location = locations.resolveLocation(deviceId, request.eventId(), request.location(), receivedAt);
