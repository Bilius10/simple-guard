...
public class DeviceUnpairingRequest {
  ...
  public static DeviceUnpairingRequest pending(
      UUID id, Device device, String agentInstanceId, OffsetDateTime requestedAt) {
  ...
  public void respondeUnpairingRequest(
      String actor, OffsetDateTime decidedAt, DeviceUnpairingRequestStatus status) {
    this.status = status;
    decidedBy = actor;
