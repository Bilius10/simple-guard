# Epic 6: Incidentes e Alertas Persistentes
...
Tasks:
- `task-6.1-abrir-incidente-para-um-dispositivo.md`
- `task-6.2-criar-e-manter-alerta-persistente.md`
- `task-6.3-encerrar-incidente-com-auditoria.md`
