...
object TelemetryJsonCodec {
    ...
    fun envelopeToJson(envelope: TelemetryEnvelope): JSONObject = JSONObject()
        .put("eventId", envelope.eventId)
        .put("location", envelope.location?.toJson() ?: JSONObject.NULL)
        .put("technical", envelope.technical.toJson())

    fun envelopeFromJson(json: JSONObject, locationStatus: LocationCollectionStatus): TelemetryEnvelope {
    ...
    private fun JSONObject.toLocation(): LocationReading = LocationReading(
    ...
    private fun JSONObject.toTechnical(): TechnicalTelemetryReading = TechnicalTelemetryReading(
    ...
    private fun JSONObject.toPermissions(): TelemetryPermissions = TelemetryPermissions(
