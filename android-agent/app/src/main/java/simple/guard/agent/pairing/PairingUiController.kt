...
class PairingUiController {
    ...
    fun waiting(): PairingUiState = PairingUiState(
    ...
    fun validating(instanceUrl: String, pairingCode: String): PairingUiState {
    ...
    fun expired(): PairingUiState = PairingUiState(
    ...
    fun failed(message: String): PairingUiState = PairingUiState(
    ...
    fun paired(deviceName: String): PairingUiState = PairingUiState(
