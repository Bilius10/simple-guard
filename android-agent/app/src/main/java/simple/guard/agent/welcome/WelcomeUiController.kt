...
class WelcomeUiController {
    ...
    fun initialScreen(hasLocalPairing: Boolean): AgentScreen =
        if (hasLocalPairing) AgentScreen.PAIRED else AgentScreen.WELCOME

    fun welcome(): WelcomeUiState = WelcomeUiState(
