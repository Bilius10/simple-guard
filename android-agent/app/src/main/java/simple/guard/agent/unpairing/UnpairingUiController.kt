...
class UnpairingUiController {
    fun confirmationRequired(): UnpairingUiState =
        UnpairingUiState(
    ...
    fun requested(): UnpairingUiState =
        UnpairingUiState(
    ...
    fun apiFailure(message: String): UnpairingUiState =
        UnpairingUiState(
    ...
    fun syncPending(): UnpairingUiState =
        UnpairingUiState(
